...
Remember: Your entire response must be valid JSON. No markdown, no explanations, just JSON.`,
    ...
    },
    {
      ...
      category: 'analysis',
      systemPrompt: `You are an expert trial consultant analyzing individual juror psychology. Your task is to provide deep insights into how a specific persona interprets a legal case based on their responses during a focus group discussion.
...
CRITICAL: You MUST respond with ONLY a valid JSON object. Do not include any text before or after the JSON. Do not use markdown formatting. Return raw JSON only.`,
      userPromptTemplate: `# Persona Case Interpretation Analysis
